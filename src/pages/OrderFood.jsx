...
// Fetch foods (fallback to mock if API is not ready)
useEffect(() => {
let alive = true
fetch('/api/foods')
...
items: items.map((i) => ({ food_id: i.food.id_food, jumlah: i.qty })),
}
...
<h2 className="flex items-center gap-2 text-lg font-semibold"><ShoppingCart className="h-5 w-5" /> Keranjang</h2>
